...
import { deleteScript } from "@/server/actions/scripts";
...
export function ScriptsClient({
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <ItemList
        empty={{ title: "No scripts yet", description: "Create your first script to get started." }}
      >
        {scripts.map((script) => (
          <ItemRow
            key={script.id}
      ...
      <ScriptFormDialog open={createOpen} onOpenChange={setCreateOpen} />
      {editing && (
        <ScriptFormDialog
